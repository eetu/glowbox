...
| `quality`     | `pixelRatio` (2) · `antialias` (true) · `alpha` (false; transparent canvas — the glow floats over the page, `background` ignored; fixed at creation) · `paused` (false) · `fps` (uncapped; cap the loop — see below)                                                                                                                                                                                                                                                                                                               |
