...
# peer: vue ^3   (@glowbox/core + @glowbox/nixie come along as dependencies)
```
...
The grouped props mirror `@glowbox/core`'s options 1:1 and update **live**. See
**@glowbox/core** for defaults, the voxel API, and colour semantics.
