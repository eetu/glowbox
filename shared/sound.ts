...
// over it — the flip-dot solenoid click, the split-flap card slap. The noise burst is
// fully shapeable (`noiseLpHz`, `noiseDecay`): a solenoid click is a bright snap, a
